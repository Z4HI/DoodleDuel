-- SQL commands to fix guesses_left field in doodle_hunt_solo table
-- Run these commands in your Supabase SQL editor

-- 1. Add guesses_left column if it doesn't exist
DO $$ 
BEGIN
    IF NOT EXISTS (
...
-- 2. Update the add_doodle_hunt_guess function to handle guesses_left
...
-- 3. Update the create_doodle_hunt_game function to initialize guesses_left
...
-- 4. Add the reset function for when user watches ad
